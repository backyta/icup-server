...
export class InitialMigration1738946101277 implements MigrationInterface {
  name = 'InitialMigration1738946101277';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE "offering_income" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "type" text NOT NULL, "sub_type" text, "category" text, "amount" numeric NOT NULL, "currency" text NOT NULL, "comments" text, "date" date NOT NULL, "image_urls" text array NOT NULL, "shift" text, "receiptCode" text NOT NULL, "inactivation_reason" text, "created_at" TIMESTAMP WITH TIME ZONE, "updated_at" TIMESTAMP WITH TIME ZONE, "record_status" text NOT NULL DEFAULT 'active', "member_type" text, "created_by" uuid, "updated_by" uuid, "church_id" uuid, "family_group_id" uuid, "pastor_id" uuid, "copastor_id" uuid, "supervisor_id" uuid, "preacher_id" uuid, "disciple_id" uuid, "external_donor_id" uuid, "zone_id" uuid, CONSTRAINT "UQ_5736c1c6bc6531021439ed7cb6c" UNIQUE ("receiptCode"), CONSTRAINT "PK_ce10159fc7ed4ae0c15214a4e6b" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
